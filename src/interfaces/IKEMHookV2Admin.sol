...
interface IKEMHookV2Admin {
  /**
   * @notice Updates the quote signer
  ...
  /**
   * @notice Updates the protocol's EG-recipient
   * @notice Can only be called by the current admin
  ...
  /**
   * @notice Updates the protocol's EG fee for a given pool
   * @notice Can only be called by the current admin
  ...
  /**
   * @notice Claims some of protocol's shares of EG
